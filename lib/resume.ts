export const profile = {
  ...
  summary:
    "Based in Helsinki, I build mapping platforms, cloud infrastructure and the deployment pipelines that ship them — currently for the Finnish government and the cities of Lahti and Jyväskylä at Triona.",
  about: [
...
export const highlights = [
  { value: "40%", label: "faster map rendering after moving from OpenLayers to MapLibre" },
  { value: "10", label: "backend services migrated to PostgreSQL and released to production" },
  { value: "3rd", label: "in Finland for the IB Extended Essay in Biology" },
  { value: "Finalist", label: "Nokia Hackathon 2022 with an agricultural drone concept" },
];
...
export const experience = [
  {
    ...
    points: [
      "Develop geospatial software on the Omakala and InfraWEB projects for the Finnish government and the cities of Lahti and Jyväskylä.",
      ...
      "Built and maintain infrastructure and deployment workflows with GitLab and ThingsBoard, including iOS App Store and Google Play releases, versioning and test management.",
    ],
